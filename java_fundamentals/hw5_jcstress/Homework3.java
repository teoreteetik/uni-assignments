...
/**
 * r1 == r2 == r3 == 1 is not possible
 * We see that for T3 and T4, the only variable that can make r2 and r3 != 0, is x
 * If x == 1 by the time r2 and r3 are evaluated, then r1 must have been evaluated to 0
 * In other words: if r1 == 1, then r2 and r3 have to be 0, because T2(3) never gets executed.
 */
@JCStressTest
